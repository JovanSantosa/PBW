            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM artikel ORDER BY id DESC LIMIT $limit_start, $limit";
                    ...
                    ?>
                        ...
                        if ($row["gambar"] != '') {
                            if (file_exists('assets/img/' . $row["gambar"] . '')) {
                        ?>
                                <br><img src="assets/img/<?= $row["gambar"] ?>" width="100">
                        <?php
                            }
                        }
                        ?>
...
?>
<p><b>Total article : <?php echo $total_records; ?></b></p>
<nav class="mb-2">
