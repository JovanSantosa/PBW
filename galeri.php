...
<div class="container mt-3">
    ...
    <div class="row">
        <div class="table-responsive" id="gambar_data">
        </div>
    </div>
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        if ($nama_gambar == '') {
            ...
            unlink("assets/img/" . $_POST['gambar_lama']);
        }
        ...
        $stmt->bind_param("sssi",  $gambar,  $desk,$tanggal, $id);
        $simpan = $stmt->execute();
        echo($simpans);
    } else {
		    //jika tidak ada id, lakukan insert data baru
        $stmt = $conn->prepare("INSERT INTO galeri (image,deskripsi,tanggal)
                                VALUES (?,?,?)");

        $stmt->bind_param("sss",   $gambar, $desk,$tanggal );
        $simpan = $stmt->execute();
    }
