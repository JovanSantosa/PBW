...
$sql = "SELECT * FROM galeri ORDER BY id DESC LIMIT $limit_start, $limit";
...
?>
        <tr>
            ...
            <?php
               if ($row["image"] != '') {
                if (file_exists('assets/img/' . $row["image"] . '')) {
            ?>
                    <img src="assets/img/<?= $row["image"] ?>" width="100">
            <?php
                }
            }
            ?>
                ...
                <div class="modal fade" id="modalEdit<?= $row["id"] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        ...
                        if ($row["image"] != '') {
                            if (file_exists('assets/img/' . $row["image"] . '')) {
                        ?>
                                <br><img src="assets/img/<?= $row["image"] ?>" width="100">
                        <?php
                            }
                        }
                        ?>
...
?>
<p><b>Total gambar : <?php echo $total_records; ?></b></p>
<nav class="mb-2">
