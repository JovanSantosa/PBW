                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        if ($row["foto"] != '') {
                                            if (file_exists('assets/img/' . $row["foto"] . '')) {
                                        ?>
                                                <br><img src="assets/img/<?= $row["foto"] ?>" width="100">
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="nama" required><?= $row["nama"] ?></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus user "<strong><?= $row["nama"] ?></strong>"?</label>
                                        <input type="hidden" name="id" value="<?= $row["id"] ?>">
...
?>
<p><b>Total user : <?php echo $total_records; ?></b></p>
<nav class="mb-2">
